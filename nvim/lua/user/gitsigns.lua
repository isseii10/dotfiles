...
M.config = function()
  ...
  wk.add {
    { "<leader>gj", require("gitsigns").next_hunk { navigation_message = false }, desc = "Next Hunk" },
    { "<leader>gk", require("gitsigns").prev_hunk { navigation_message = false }, desc = "Prev Hunk" },
